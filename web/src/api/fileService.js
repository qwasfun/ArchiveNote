...
// 获取预签名上传URL（用于S3直传）
export function getPresignedUploadUrl(filename, contentType, params) {
...
// 确认直传完成，创建文件记录
export function confirmDirectUpload(data) {
...
// 直接上传到S3（使用预签名URL）
export async function uploadToS3(presignedData, file) {
